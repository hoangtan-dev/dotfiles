...
(function () {
  ...
  function log(...args) {
    ...
    console.log(
      "%c[ShortsRemover] " + message,
      "color: " + config.c_consoleColor,
    );
  }
  ...
  var config = {
    ...
    c_removeFormSubscriptionFeed: GM_getValue(
      "c_removeFormSubscriptionFeed",
      true,
    ),
    ...
    c_disableShortPageScrolling: GM_getValue(
      "c_disableShortPageScrolling",
      true,
    ),
  ...
  var youtubeFeedPagePattern =
    /^https?:\/\/(www\.)?youtube\.com\/((feed)|(gaming))(?!\/subscriptions.*).*$/;

  // Define the regex pattern for the YouTube subscriptions feed page
  //https://www.youtube.com/feed/subscriptions
  var youtubeSubscriptionsPagePattern =
    /^https?:\/\/(www\.)?youtube\.com\/feed\/subscriptions\/?$/;
  ...
  function removeShorts() {
    ...
    if (configPagePattern.test(currentURL)) {
      ...
      if (
        document.querySelector(
          "div#contents.style-scope.ytd-section-list-renderer>#yt-short-remover-config-menu",
        )
      ) {
    ...
    if (
      youtubeStartPagePattern.test(currentURL) &&
      config.c_removeFormStartPage
    ) {
      // URL & config matches
    ...
    if (
      youtubeFeedPagePattern.test(currentURL) &&
      config.c_removeFormAllFeeds
    ) {
      // URL & config matches
    ...
    if (
      youtubeSubscriptionsPagePattern.test(currentURL) &&
      config.c_removeFormSubscriptionFeed
    ) {
      // URL & config matches
      removeFormVideoOverview();
    ...
    if (
      youtubeWatchPagePattern.test(currentURL) &&
      config.c_removeFormFollowUp
    ) {
      // URL & config matches
      removeReelShelfRenderer();
      return;
    ...
    if (
      youtubeChannelPagePattern.test(currentURL) &&
      config.c_removeFormChannel
    ) {
    ...
    if (
      youtubeSearchPagePattern.test(currentURL) &&
      config.c_removeFormSearch
    ) {
      // URL & config matches
      removeReelShelfRenderer();
      removeFormVideoOverview();
  ...
  function createConfigMenu() {
    ...
    var menuItems = [
      {
        label: "Remove Shorts from Start Page",
        key: "c_removeFormStartPage",
        type: "checkbox",
      },
      {
        label: "Remove Shorts from Subscription Feed",
        key: "c_removeFormSubscriptionFeed",
        type: "checkbox",
      },
      {
        label: "Remove Shorts from All Feeds (except Subscription Feed)",
        key: "c_removeFormAllFeeds",
        type: "checkbox",
      },
      {
        label: "Remove Shorts from Follow Up Page",
        key: "c_removeFormFollowUp",
        type: "checkbox",
      },
      {
        label: "Remove Shorts from Channel Page",
        key: "c_removeFormChannel",
        type: "checkbox",
      },
      {
        label: "Remove Shorts from Search Page",
        key: "c_removeFormSearch",
        type: "checkbox",
      },
      {
        label: "Remove Sidebar Shorts",
        key: "c_removeSidebar",
        type: "checkbox",
      },
      {
        label: "Disable Short Page",
        key: "c_disableShortPage",
        type: "checkbox",
      },
      {
        label: "Disable Short Page Scrolling",
        key: "c_disableShortPageScrolling",
        type: "checkbox",
      },
      {
        label: "Console log Color:",
        key: "c_consoleColor",
        type: "color",
        default: "#33bd52",
      },
    ...
    menuItems.forEach((item) => {
      ...
      if (input.type == "checkbox") {
        ...
        input.value = GM_getValue(
          item.key,
          item.default ? item.default : "undefine",
        );
      }
    ...
    document
      .querySelector("div#contents.style-scope.ytd-section-list-renderer")
